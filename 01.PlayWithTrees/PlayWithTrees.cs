namespace _01.PlayWithTrees
{
    ...
    public static class PlayWithTrees
    {
        ...
        public static void Main()
        {
            ...
            Console.WriteLine($"Root node: {rootVertex.Value}");

            // Find leafs
            var allLeafVertices = FindLeafVertices();
            Console.WriteLine($"Leaf nodes: {string.Join(", ", allLeafVertices)}");

            // Find middle nodes
            var allMiddleVertices = FindMiddleVertices();
            Console.WriteLine($"Leaf nodes: {string.Join(", ", allMiddleVertices)}");
